...
Monitor Expiry Dates
             |
             v
Renew Expired / Expiring Documents
             |
             v
...
Determine Outcome
      /        |          \
Appointed  Unsuccessful  Awaiting

8.3 Proposed Improved Process
       ...
       |                   |
       v                   v
Compliance Management   Tender Management
       |                   |
       v                   v
Documents & Certificates Opportunities
       |                   |
       v                   v
Expiry Tracking         Requirements
       |                   |
       v                   v
Compliance Status       Qualification
       |                   |
       +---------+---------+
                 |
                 v
...
Both applications will communicate with the same Supabase backend and PostgreSQL database, allowing information entered through one application to be accessed through the other where authorised.
...
Main Functions
Flutter Mobile Application
Sign in, view compliance status, view documents, view expiry information, view tenders, track tender status and follow-ups
ASP.NET Web Application
Manage documents, certificates, tender opportunities, requirements, qualification, submissions, follow-ups and outcomes
Supabase
Authentication, backend services and communication between applications and database
PostgreSQL
